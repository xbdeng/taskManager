...
body {
  ...
  background: radial-gradient(rgba(#7600bf, 0.5) 0%, transparent 70%), linear-gradient(#ffffff 40%, #202076 70%);
  perspective: 700px;
...
h2 {
  ...
  margin-top: -0.6em;
  color: white;
  text-shadow: 0 0 0.05em #fff, 0 0 0.2em #070202, 0 0 0.3em #000000;
