...
class TaskManagerApplicationTests {
    ...
    void contextLoads() throws Exception {
        ...
        CreateTaskParams params = new CreateTaskParams().setUsername("ddd").setTaskName("try").setDescription("try")
                .setTags(tags).setPrivilege(1).setType(0).setCreateDate("2020-11-16T00:01:45.000Z").setDueDate("2020-11-15T00:01:45.000Z").setStatus(1);
        int result =taskServiceImpl.addTask(params.setFatherTask(BigInteger.valueOf(11)));
